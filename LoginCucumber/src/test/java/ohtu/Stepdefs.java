...
public class Stepdefs {
    ...
    @When("^username \"([^\"]*)\" and password \"([^\"]*)\" are selected$")
    public void username_and_password_are_selected(String username, String password) throws Throwable {
    ...
    @Given("^user \"([^\"]*){3,}\" with password \"([^\"]*){8,}\" is created$")
